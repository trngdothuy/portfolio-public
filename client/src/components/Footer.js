...
return (
	<div className="footer">
        <div className="foot-1">
            ...
            <div className="nav-box">
                <a className="footer-a" href="https://www.linkedin.com/in/trang-do-thuy-183435141/" target="_blank" rel="noreferrer">
                    linkedin
        ...
        <div className="foot-2">
            <div className="nav-box">
                <a className="footer-a" href="https://github.com/trngdothuy" target="_blank" rel="noreferrer">
                    @trngdothuy
